...
from langgraph_swarm.swarm import StateGraph as SwarmStateGraph,create_swarm
...
math_graph.name="Math"

graph = create_swarm([internet_graph,math_graph],default_active_agent="Internet")